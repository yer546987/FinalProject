...
{
    public class UsuariosServices : IUsuariosSercices
    {
        ...
        public RequestResult<UsuarioDto> Create(UsuarioDto usuario)
        {
            try
            {
                ...
                entity.Usuario1 = usuario.Usuario1;
        ...
        public RequestResult<UsuarioDto> GetById(int idUsuario)
        {
            try
            {
                ...
                if (usuario == null) return RequestResult<UsuarioDto>.CreateNoSuccess($"No existe el usuario con identificador {idUsuario}");
                var resultado = new UsuarioDto()
                {
                    Id = usuario.Id,
        ...
        public UsuarioDto Update(UsuarioDto usuario)
        {
            ...
            if (string.IsNullOrEmpty(usuario.Usuario1)) return null;
